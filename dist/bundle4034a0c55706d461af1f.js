...
function Contact() {
  ...
  var userName = ["Chef's Name", "Barista's Name", "Manager's Name"];
  var userRole = ["Chef", "Barista", "Manager"];
  var userNumber = ["155-5555-555", "555-5555-55", "123-4567-890"];
  var userEmail = ["realemailCHEF@emailreal.com", "realemailBARISTA@emailreal.com", "realemailMANAGER@emailreal.com"];
...
function Home() {
  ...
  review.textContent = "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Atque vero nesciunt molestiae nisi, sit illum deserunt iste ut rerum fugit, excepturi velit quidem incidunt laudantium dolorum, iure quas suscipit voluptas.";
  ...
  hours.innerHTML = "Sunday: 8am - 8pm<br>Monday: 6am - 6pm<br>Tuesday: 6am - 6pm<br>Wednesday: 6am - 6pm<br>Thursday: 6am - 10pm<br>Friday: 6am - 10pm<br>Saturday: 8am - 10pm<br>";
...
function Menu() {
  ...
  var itemTitle = ["Black Coffee", "Moccacino", "Expresso"];
  var title = document.createElement("h1");
  ...
  for (var i = 0; i < 3; i++) {
    ...
    var itemTitleText = document.createElement("div");
    itemTitleText.innerText = itemTitle[i];
    itemTitleText.setAttribute("class", "item__title");
    var itemDescription = document.createElement("div");
    itemDescription.innerText = "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Lorem ipsum dolor sit, amet consectetur adipisicing elit.";
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".contact {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 70%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.contact__user {\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  max-width: 600px;\n  padding: 8px 3%;\n  font-weight: bold;\n  min-width: 40%;\n  line-break: auto;\n  font-size: min(2.5vw, 1rem);\n}", "",{"version":3,"sources":["webpack://./src/styles/contact.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,UAAA;EACA,SAAA;EACA,aAAA;EACA,kBAAA;AACF;;AAEA;EACE,4CAAA;EACA,gBAAA;EACA,eAAA;EACA,iBAAA;EACA,cAAA;EACA,gBAAA;EACA,2BAAA;AACF","sourcesContent":[".contact {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 70%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.contact__user {\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  max-width: 600px;\n  padding: 8px 3%;\n  font-weight: bold;\n  min-width: 40%;\n  line-break: auto;\n  font-size: min(2.5vw, 1rem);\n}\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".home {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 75%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.home__title {\n  padding-top: 8px;\n}\n\n.home__review,\n.home__hours,\n.home__adress {\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  max-width: 600px;\n  padding: 8px;\n  font-weight: bold;\n}\n\n.home__highlight-text {\n  padding-top: 4px;\n  padding-left: 8px;\n  font-size: 20px;\n  display: block;\n}\n\n.home__hours {\n  padding: 8px 16px;\n  line-height: 24px;\n}", "",{"version":3,"sources":["webpack://./src/styles/home.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,UAAA;EACA,SAAA;EACA,aAAA;EACA,kBAAA;AACF;;AAEA;EACE,gBAAA;AACF;;AAEA;;;EAGE,4CAAA;EACA,gBAAA;EACA,YAAA;EACA,iBAAA;AACF;;AAEA;EACE,gBAAA;EACA,iBAAA;EACA,eAAA;EACA,cAAA;AACF;;AAEA;EACE,iBAAA;EACA,iBAAA;AACF","sourcesContent":[".home {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 75%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.home__title {\n  padding-top: 8px;\n}\n\n.home__review,\n.home__hours,\n.home__adress {\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  max-width: 600px;\n  padding: 8px;\n  font-weight: bold;\n}\n\n.home__highlight-text {\n  padding-top: 4px;\n  padding-left: 8px;\n  font-size: 20px;\n  display: block;\n}\n\n.home__hours {\n  padding: 8px 16px;\n  line-height: 24px;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  margin: 0px;\n  font-family: Arial, Helvetica, sans-serif;\n  margin: 0px;\n  margin-bottom: 12px;\n}\n\n.container {\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nh1 {\n  margin: 0;\n}\n\n.header {\n  background-color: pink;\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  margin-bottom: 40px;\n}\n\n.header__buttons {\n  display: flex;\n  text-align: center;\n  gap: 16px;\n}\n\n.header__button {\n  padding: min(2vw, 16px);\n  font-weight: bold;\n  border: 1px solid black;\n}\n\n.header__button:hover {\n  background-color: red;\n}", "",{"version":3,"sources":["webpack://./src/styles/main.scss"],"names":[],"mappings":"AAAA;EACE,WAAA;EACA,yCAAA;EACA,WAAA;EACA,mBAAA;AACF;;AAEA;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;AACF;;AAEA;EACE,SAAA;AACF;;AAEA;EACE,sBAAA;EACA,aAAA;EACA,uBAAA;EACA,WAAA;EACA,mBAAA;AACF;;AAEA;EACE,aAAA;EACA,kBAAA;EACA,SAAA;AACF;;AAEA;EACE,uBAAA;EACA,iBAAA;EACA,uBAAA;AACF;;AAEA;EACE,qBAAA;AACF","sourcesContent":["body {\n  margin: 0px;\n  font-family: Arial, Helvetica, sans-serif;\n  margin: 0px;\n  margin-bottom: 12px;\n}\n\n.container {\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nh1 {\n  margin: 0;\n}\n\n.header {\n  background-color: pink;\n  display: flex;\n  justify-content: center;\n  width: 100%;\n  margin-bottom: 40px;\n}\n\n.header__buttons {\n  display: flex;\n  text-align: center;\n  gap: 16px;\n}\n\n.header__button {\n  padding: min(2vw, 16px);\n  font-weight: bold;\n  border: 1px solid black;\n}\n\n.header__button:hover {\n  background-color: red;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".menu {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 70%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.menu__item {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  max-width: 600px;\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  padding: 8px;\n  font-weight: bold;\n}", "",{"version":3,"sources":["webpack://./src/styles/menu.scss"],"names":[],"mappings":"AAAA;EACE,sBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,UAAA;EACA,SAAA;EACA,aAAA;EACA,kBAAA;AACF;;AAEA;EACE,aAAA;EACA,sBAAA;EACA,QAAA;EACA,gBAAA;EACA,4CAAA;EACA,YAAA;EACA,iBAAA;AACF","sourcesContent":[".menu {\n  background-color: plum;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  width: 70%;\n  gap: 24px;\n  padding: 16px;\n  border-radius: 8px;\n}\n\n.menu__item {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  max-width: 600px;\n  border: 3px solid rgba(255, 192, 203, 0.397);\n  padding: 8px;\n  font-weight: bold;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _styles_contact_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/contact.scss */ "./src/styles/contact.scss");
...
home.addEventListener("click", _scripts_home__WEBPACK_IMPORTED_MODULE_4__["default"]);
var menu = document.querySelector(".header__menu");
menu.addEventListener("click", _scripts_menu__WEBPACK_IMPORTED_MODULE_5__["default"]);
var contact = document.querySelector(".header__contact");
contact.addEventListener("click", _scripts_contact__WEBPACK_IMPORTED_MODULE_6__["default"]);
(0,_scripts_home__WEBPACK_IMPORTED_MODULE_4__["default"])();
})();

/******/ })()
;
//# sourceMappingURL=bundle4034a0c55706d461af1f.js.map